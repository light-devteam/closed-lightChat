...
| **`senderFormat`**         | The format of the message that the sender sees. <br>**Leave blank to prevent the sender from seeing his message**                                                                                                                                                                                                                                                                                         | <ul><li> **`{sender}`**</li> <li>**`{recipient}`**</li> <li>**`{recipientPrefix}`**</li> <li>**`{recipientSuffix}`**</li> <li>**`{message}`**</li></ul> |
